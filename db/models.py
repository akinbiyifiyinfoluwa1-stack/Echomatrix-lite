...
class BacktestRun(Base):
    """Result of replaying Quick Brain against stored historical
    candles for one symbol — what the weekend practice loop produces,
    and what a manual backtest run also writes to."""
